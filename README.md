...
<p align="center">
  ...
  Turning ideas into fast, scalable products — from pixel-perfect UIs to robust backends.
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Open%20to%20Opportunities-%2358A6FF?style=flat-square&logo=statuspage&logoColor=white" />
  <img src="https://img.shields.io/badge/Based%20in-India-3fb950?style=flat-square" />
  <img src="https://img.shields.io/badge/Full%20Stack-Engineer-58a6ff?style=flat-square" />
</p>
...
```
Frontend   →  React, Tailwind CSS, Three.js, React Native
Backend    →  Node.js, Express, WebSockets, JWT
Databases  →  MongoDB, Supabase, Firebase
APIs/Tools →  Google Maps API, Gemini AI, Cloudinary, Redux, face-api.js
```
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/AayushAtMars/AayushAtMars/output/github-contribution-grid-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/AayushAtMars/AayushAtMars/output/github-contribution-grid-snake.svg" />
    <img alt="Snake eating contributions" src="https://raw.githubusercontent.com/AayushAtMars/AayushAtMars/output/github-contribution-grid-snake.svg" />
  </picture>
</p>
...
<p align="center">
  <sub>AayushAtMars · Built with curiosity and too much coffee ☕</sub>
</p>
